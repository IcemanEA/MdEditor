...
final class AboutWorker: IAboutWorker {
	...
	func fetchAboutData() -> String {
		guard let path = Bundle.main.path(forResource: L10n.Localizable.About.file, ofType: "md") else {
			return L10n.Localizable.Error.aboutScene
		}
		do {
			let text = try String(contentsOfFile: path, encoding: .utf8)
			return text
		} catch {
			return L10n.Localizable.Error.open + L10n.Localizable.Error.aboutScene
		}
	}
}
